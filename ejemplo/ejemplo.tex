...
\fancyhead[C]{Modelado y Simulación $\bullet$ December 2014 $\bullet$ Proyectos} % Custom header text
...
\author{
\large
\textsc{Roberto Cadena Vega}\thanks{A thank you or further information}\\[2mm] % Your name
