\message{ !name(resultados.tex)}\documentclass[paper=a4, fontsize=11pt]{scrartcl} % A4 paper and 11pt font size
...
\message{ !name(resultados.tex) !offset(-3) }
...
\end{document}
\message{ !name(resultados.tex) !offset(-165) }
